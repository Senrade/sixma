  ...
  return (
    <RetroWindow title={t("module.image.windowTitle")}>
      ...
      <div className="grid min-h-0 gap-4 md:grid-cols-[minmax(0,1fr)_minmax(260px,380px)]">
        {/*
          ĐIỀU CHỈNH 1: Thêm px-6 py-2 trên mobile (md:p-0) 
          tạo vùng đệm trống 2 bên lề để ngón tay dễ dàng bám vào vuốt/cuộn trang
        */}
        <div className="flex min-h-0 items-center justify-center overflow-hidden px-6 py-2 md:p-0">
          <div
            ...
            /*
              ĐIỀU CHỈNH 2: 
              - Mobile: Đổi dvh sang chiều cao cố định h-[210px] / h-[270px] để hết bị giật/scale khi cuộn.
              - PC/Tablet (md:): GIỮ NGUYÊN md:h-auto md:max-h-[calc(100dvh-60px)].
            */
            className={`relative w-full max-w-full touch-none overflow-hidden rounded-[6px] border-2 border-ink bg-black shadow-[5px_5px_0_0_var(--color-ink)] ${
              ...
              activeAnomaly
                ? "h-[210px] md:h-auto md:max-h-[calc(100dvh-60px)]"
                : "h-[270px] md:h-auto md:max-h-[calc(100dvh-60px)]"
            }`}
          >
            <Image
              src={imageUrl}

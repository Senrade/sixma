...
export const gameOption =
  "flex min-h-11 cursor-pointer items-start gap-2 rounded-[5px] border-2 border-ink bg-background px-3 py-2 text-sm leading-6 text-ink transition-transform hover:-translate-y-px has-[:checked]:bg-accent has-[:checked]:shadow-[2px_2px_0_0_var(--color-ink)]";
